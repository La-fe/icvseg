...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.txt_f =  ['/data1/datasets_lafe/mask/skin_segm/mix-cnt20000-size2000-q95-split/layouts/mt_faceskin_mix_cnt20000_train.txt',
                           '/data1/datasets_lafe/mask/skin_segm/skin_mask/layouts/ATR_train.txt',
                           '/data1/datasets_lafe/mask/CelebA/layout_mt/skin/celebA_skin_cla_pure_train.txt']

            self.root_dir = ['/data1/datasets_lafe/mask/skin_segm/mix-cnt20000-size2000-q95-split',
                             '/data1/datasets_lafe/mask/skin_segm',
                             '/data1/datasets_lafe/mask/CelebA'
                             ]

            self.val_txt_f = ['/data1/datasets_lafe/mask/skin_segm/mix-cnt20000-size2000-q95-split/layouts/mt_faceskin_mix_cnt20000_val.txt',
                              '/data1/datasets_lafe/mask/skin_segm/skin_mask/layouts/ATR_val.txt',
                              '/data1/datasets_lafe/mask/CelebA/layout_mt/skin/celebA_skin_cla_pure_val.txt'
                              ]
            self.val_root_dir = ['/data1/datasets_lafe/mask/skin_segm/mix-cnt20000-size2000-q95-split',
                                 '/data1/datasets_lafe/mask/skin_segm',
                                 '/data1/datasets_lafe/mask/CelebA'
                                 ]

        self.DATA_WORKERS = 40
        ...
        if flag_debug is True:
            ...
            self.GPUS_ID = [2, 3]
            self.batch_size_per_gpu = 40  # 每张卡的bs
        ...
        self.TRAIN_CKPT = "/home/lafe/mt/segmentation/icvseg/ckpt/model/mt_human_skin_art_celebpure/best_model_mt_human_skin_art_celebpure_miou.pth"
