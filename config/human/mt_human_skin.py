...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.txt_f =  '/home/lafe/datasets/mask/skin_segm/skin_mask/layouts/ATR_train.txt'
            self.root_dir = '/home/lafe/datasets/mask/skin_segm'

            self.val_txt_f = '/home/lafe/datasets/mask/skin_segm/skin_mask/layouts/ATR_val.txt'
            self.val_root_dir = '/home/lafe/datasets/mask/skin_segm'
