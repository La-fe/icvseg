...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.txt_f =  ['/data1/datasets_lafe/mask/id_human_mt/layouts/id_human_train.txt',
                           '/data1/datasets_lafe/mask/id_human_mt/layouts/mt_alpha_train.txt'
                           ]
            self.root_dir = ['/data1/datasets_lafe/mask/id_human_mt',
                             '/data1/datasets_lafe/mask/id_human_mt'
                             ]

            self.val_txt_f = ['/data1/datasets_lafe/mask/id_human_mt/layouts/id_human_val.txt',
                              '/data1/datasets_lafe/mask/id_human_mt/layouts/mt_alpha_val.txt'
                              ]
            self.val_root_dir = ['/data1/datasets_lafe/mask/id_human_mt',
                                 '/data1/datasets_lafe/mask/id_human_mt'
                                 ]
        ...
        self.TRAIN_SAVE_CHECKPOINT = 50  # save checkpoint
        ...
        self.TRAIN_CKPT = '/home/lafe/mt/segmentation/mmsegment_v1/ckpt/model/mt_human_no_idphoto/mt_human_no_idphoto_epoch48_all.pth'
        ...
        self.VAL_CHECKPOINT = 50  # val checkpoint
