...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.txt_f =  [
                           '/data1/datasets_lafe/mask/human_alpha/layouts/mt_alpha_train.txt'
                           ]
            self.root_dir = [
                             '/data1/datasets_lafe/mask/human_alpha/id_crop'
                             ]

            self.val_txt_f = [
                              '/data1/datasets_lafe/mask/human_alpha/layouts/mt_alpha_val.txt'
                              ]
            self.val_root_dir = [
                                 '/data1/datasets_lafe/mask/human_alpha/id_crop'
                                 ]
        ...
        # ----------------- optmi ------------------------
        self.TRAIN_LR = 0.001 # learning rate finetune model
        ...
        self.TRAIN_CKPT = '/home/lafe/mt/segmentation/mmsegment_v1/ckpt/model/mt_human/mt_human_epoch48_all.pth'
