...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.txt_f =  '/data1/datasets_lafe/mask/CelebA/layout_mt/skin/celebA_skin_cla_pure_train.txt'
            self.root_dir = '/data1/datasets_lafe/mask/CelebA'

            self.val_txt_f = '/data1/datasets_lafe/mask/CelebA/layout_mt/skin/celebA_skin_cla_pure_val.txt'
            self.val_root_dir = '/data1/datasets_lafe/mask/CelebA'
