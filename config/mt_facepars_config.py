...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.txt_f = '/home/lafe/datasets/CelebAMask-HQ/layout_mt/mt_CelebA-HQ_train.txt'
            self.root_dir = '/home/lafe/datasets/CelebAMask-HQ'

            self.val_txt_f = '/home/datasets/lafe/CelebAMask-HQ/layout_mt/mt_CelebA-HQ_val.txt'
            self.val_root_dir = '/home/lafe/datasets/CelebAMask-HQ'
