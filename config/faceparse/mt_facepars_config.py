...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.val_txt_f = '/home/lafe/datasets/CelebAMask-HQ/layout_mt/mt_CelebA-HQ_val.txt'
        ...
        if flag_debug is True:
            ...
            self.GPUS_ID = [2, 3]
            self.batch_size_per_gpu = 16  # 每张卡的bs
        ...
        if flag_debug:
            ...
            self.val_batch_size_per_gpu = 8

        self.VAL_CHECKPOINT = 1000  # val checkpoint
