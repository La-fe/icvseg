...
class Configuration():
    def __init__(self):
        ...
        if flag_debug is True:
            ...
            self.txt_f = '/home/datasets/CelebAMask-HQ/layout_mt/mt_CelebA-HQ_train.txt'
            self.root_dir = '/home/datasets/CelebAMask-HQ'

            self.val_txt_f = '/home/datasets/CelebAMask-HQ/layout_mt/mt_CelebA-HQ_val.txt'
        ...
        self.MODEL_NUM_CLASSES = 19  # class
