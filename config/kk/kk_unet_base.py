...
class Configuration():
    ...
    # ----------------- dataset ----------------------
        if flag_debug is True:
            self.txt_f = '/home/xjx/data/mask/seg_coco_LIP/layout/split_train_val/precise_coco_lip_train.txt'
            self.root_dir = '/home/xjx/data/mask/seg_coco_LIP'

            self.val_txt_f = '/home/xjx/data/mask/seg_coco_LIP/layout/split_train_val/precise_coco_lip_val.txt'
            self.val_root_dir = '/home/xjx/data/mask/seg_coco_LIP'
        else:
            self.txt_f = '/home/zhangming/Datasets/mask/Kaggle/rematch/data/train1.txt'
            self.root_dir = '/home/zhangming/Datasets/mask/Kaggle/rematch/data'

            self.val_txt_f = '/home/zhangming/Datasets/mask/Kaggle/rematch/data/test1.txt'
            self.val_root_dir = '/home/zhangming/Datasets/mask/Kaggle/rematch/data'

        self.DATA_WORKERS = 8
        self.DATA_RESCALE = int(512)
        self.DATA_RANDOMCROP = 0
        self.DATA_RANDOMROTATION = 0
        self.DATA_RANDOMSCALE = 2 # 1/r ~ r 的范围
    ...
    # ----------------- model ------------------------
        ...
        self.MODEL_NUM_CLASSES = 5 # class
    ...
    # ----------------- optmi ------------------------
        self.TRAIN_LR = 0.005   # learning rate
    ...
    # ----------------- adjust lr --------------------
        ...
        if flag_debug is True:
            self.GPUS_ID = [0,0]
            self.batch_size_per_gpu = 2 # bs
        else:
            self.GPUS_ID = [2, 3]
            self.batch_size_per_gpu = 5 # 每张卡的bs

        self.TRAIN_SAVE_CHECKPOINT = 2000  # save checkpoint
        self.TRAIN_SHUFFLE = True
        self.display = 100

        self.TRAIN_MINEPOCH = 0
        self.TRAIN_EPOCHS = 46  # epoch
        ...
        if flag_debug:
            ...
            self.val_batch_size_per_gpu = 5

        self.VAL_CHECKPOINT = 2000  # val checkpoint
