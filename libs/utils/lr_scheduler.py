...
if __name__ == '__main__':
    ...
    print("CyclicScheduler Visualization")
    ...
    scheduler = CyclicScheduler(base_lr=0.001, max_lr=0.1, step=8*num_its, mode='triangular', gamma=1., scale_fn=None, scale_mode='cycle') ##exp_range ##triangular2
    # step_size = (2-8) x (training iterations in epoch). Default 2000.

    lrs = np.zeros((num_epoches * num_its),np.float32)
