...
from datasets.transform import ToTensor
from lib.datasets import RemoDataset
...
if __name__ == '__main__':
    cfg.bs = 4
    cfg.num_workers = 4
    # cfg.txt_f = '/home/xjx/data/mask/Kaggle/data_crop/layout/test_ratio124.txt'
    # cfg.txt_f = '/home/xjx/data/mask/Kaggle/data_crop/test.txt'
    cfg.txt_f = '/home/xjx/data/mask/Kaggle/data_crop/layout/test_124510.txt' # 测试集txt

    cfg.TEST_CKPT = '/home/xjx/data/model/Kaggle/kk_ratio_124_itr56000.pth'
    # cfg.TEST_CKPT = '/home/xjx/data/model/Kaggle/kk_ratio_12410_itr58000.pth'

    '[0.93543999 0.9752281  0.86732708 0.91484315]'
    '''
          b: 93.590%	          1: 96.135%
          2: 88.532%	          3: 91.124%
    '''
