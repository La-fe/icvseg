...
class COCODataset(Dataset):
    def __init__(self, dataset_name, cfg, period):
        ...
        self.root_dir = '/home/zhangming/work/YF_remo/xsfd/Detectron.pytorch-master/data/coco'
                            # os.path.join(cfg.ROOT_DIR,'data','MSCOCO')
        self.dataset_dir = '/home/zhangming/work/YF_remo/xsfd/Detectron.pytorch-master/data/coco'
                            # self.root_dir
        
        self.period = period
        self.year = self.__get_year()
        # print(self.dataset_name,self.root_dir,self.dataset_dir)
        # sys.exit(1)
