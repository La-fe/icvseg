...
from libs.utils.util_color import tensor2label as tensor2label
...
if __name__ == '__main__':
    ...
    # imgs_dir = '/data1/datasets_lafe/a2b_data/complete_idphoto_8_21/train_A_nopad_ali'
    imgs_dir = '/data1/datasets_lafe/a2b_data/complete_idphoto_8_21/train_A_nopad_ali'
    flag_save = False
    ...
    nets_dict = {
        'Decorate': NetLoader(cfg, 'deeplabv3plus', 'res101_atrous',
                          ckpt='/home/lafe/mt/segmentation/icvseg/ckpt/model/mt_human_skin_art_celebpure_pretrain_mtdata/mt_human_skin_art_celebpure_pretrain_mtdata_epoch48_all.pth',
                          # ckpt='/home/lafe/mt/segmentation/icvseg/ckpt/model/mt_human_skin_art_celebpure/mt_human_skin_art_celebpure_epoch48_all.pth',
                          num_classes=2, flip=False, multi_scale=1, vis_type='color_mask'),
    }
